...
<html>
    ...
    <body>
        ...
        <a href=KB.php class="btn btn-dark">Back</a>
            ...
            <?php
                if($content_format==="Video"){ ?>
                    <div style="display: flex; justify-content: center; align-items: center; ">
                        <video src="../admin/manage-content/uploads/<?=$content?>" style="width: 60%; max-height: 100%;" controls>
                        </video>
                    </div>
                ...
                <div style="display: flex; justify-content: center; align-items: center; ">
                    <img src="../admin/manage-content/img/<?=$content?>" 
                ...
                <?php 
                    ...
                    <div style="width: 100%; height: 100vh;">
                        <embed src="../admin/manage-content/pdf/<?=$content?>" type="application/pdf" width="100%" height="100%" controls>
                    </div>
